...
public class A {
    ...
    public static void main(String args[]) {
        //Mat template = Imgcodecs.imread("C:\\Users\\Cole Savage\\Desktop\\SHAPEZ\\box.png");
        //Mat scene = Imgcodecs.imread("C:\\Users\\Cole Savage\\Desktop\\SHAPEZ\\box_in_scene.png");

        Mat scene = Imgcodecs.imread("C:\\Users\\Cole Savage\\Desktop\\20180910_095634.jpg");
        Mat template = Imgcodecs.imread("C:\\Users\\Cole Savage\\Desktop\\test.jpg");
        ...
        Mat display = new Mat();
        Features2d.drawMatches(template,templateKeyPoints,scene,sceneKeyPoints,goodMatches,display);
        showResult(display);
